...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: '数据权限', content: '所有用户均可查看全部客户信息；编辑与删除仅限客户负责人或管理员，普通用户查看非本人客户时为只读模式。拜访记录仍按负责人与部门范围控制可见性。' },
    ],
  },
  {
    id: 'VISITS',
  ...
  },
  {
    ...
    items: [
      ...
      { title: '客户清单模板', content: '输入区上方提供四个固定模板：三个类别模板（地方政府 / 金融机构 / 产业客户，仅含重点客户）与全量客户清单（不限类型与重点标记），点击即可生成详细信息清单，支持全屏查看与一键导出 Excel。模板功能仅对管理员、总经理室与风险管理部成员开放。' },
    ],
  },
  {
    id: 'ADMIN',
...
const FAQS = [
  ...
  { question: '为什么无法编辑某些客户？', answer: '所有用户均可查看客户信息，但编辑与删除仅限客户负责人或管理员；查看非本人负责的客户时为只读模式。如需调整，请联系管理员修改客户负责人。' },
